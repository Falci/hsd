...
main.deployments = {
  ...
  extendedNameClaim: {
    name: 'extendedNameClaim',
    bit: 1,
    startTime: 1660435200, // August 14th, 2022
    timeout: 1691971200, // August 14th, 2022
    threshold: -1,
    window: -1,
    required: false,
    force: false
...
main.deploys = [
  ...
  main.deployments.extendedNameClaim,
];
...
testnet.deploys = [
  ...
  testnet.deployments.extendedNameClaim
];
...
regtest.deploys = [
  ...
  regtest.deployments.extendedNameClaim
];
...
simnet.deploys = [
  ...
  simnet.deployments.extendedNameClaim
];
