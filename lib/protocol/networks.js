...
main.names = {
  ...
  originalClaimPeriod: (4 * 365) * main.pow.blocksPerDay,
   ...
   * @const {Number}
   */
  claimPeriod: (8 * 365) * main.pow.blocksPerDay,
...
testnet.names = {
  ...
  originalClaimPeriod: 90 * testnet.pow.blocksPerDay,
  claimPeriod: 180,
